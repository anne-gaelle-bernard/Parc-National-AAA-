...
--
-- Insertion des données pour la table `trail`
--

INSERT INTO `trail` (`id`, `name`, `difficulty`, `estimated_duration`, `description`, `map_url`)
VALUES
...
--
-- Insertion des données pour la table `point_of_interest`
--

INSERT INTO `point_of_interest` (`name`, `description`, `gps_coordinates`, `trail_id`)
VALUES
...
--
-- Insertion des données pour la table `resource`
--

INSERT INTO `resource` (`species_type`, `species_name`, `description`, `location`, `trail_id`, `author_id`)
VALUES
